...
public class WallPaperDetailsActivity extends AppCompatActivity {
    ...
    private class ImagePagerAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(@NonNull ViewGroup container, final int position) {
            ...
            final SimpleDraweeView draweeView = imageLayout.findViewById(R.id.my_image_view);

            final CircularProgressBar progressBar = imageLayout.findViewById(R.id.pb_wall_details);

            Uri uri = Uri.parse(methods.getImageThumbSize(Constant.arrayList.get(position).getImageThumb(), getString(R.string.details)));
            ...
            draweeView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent intent = new Intent(WallPaperDetailsActivity.this, WallPaperViewActivity.class);
