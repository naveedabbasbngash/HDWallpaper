...
import zs.wallpapers.site.BuildConfig;
...
public class Constant implements Serializable {
    ...
    public static final String URL_WALL_LANDSCAPE = SERVER_URL + "api.php?get_landscape_wallpaper&page=";
    public static final String URL_WALL_PORTRAIT = SERVER_URL + "api.php?get_portrait_wallpaper&page=";
    public static final String URL_WALL_SQUARE = SERVER_URL + "api.php?get_square_wallpaper&page=";
    ...
    public static final String TAG_POTRAIT_WALL = "portrait_wallpaper";
    public static final String TAG_LANDSCAPE_WALL = "landscape_wallpaper";
    public static final String TAG_SQUARE_WALL = "square_wallpaper";
    ...
    public static Boolean isBannerAd = true, isInterAd = true, isGIFEnabled = true;
